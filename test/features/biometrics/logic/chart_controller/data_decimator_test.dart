  ...
  group('DataDecimator', () {
    ...
    group('LTTB Downsampling', () {
      ...
      test('should preserve min and max values', () {
        final originalMin = testData.map((e) => e.y).reduce((a, b) => a < b ? a : b);
        final originalMax = testData.map((e) => e.y).reduce((a, b) => a > b ? a : b);
        
        final result = DataDecimator.lttbDownsample(testData, 10);
        final resultMin = result.map((e) => e.y).reduce((a, b) => a < b ? a : b);
        final resultMax = result.map((e) => e.y).reduce((a, b) => a > b ? a : b);
    ...
    group('Adaptive Decimation', () {
      test('should apply more aggressive decimation for higher zoom levels', () {
    ...
    group('Performance Metrics', () {
      test('should calculate correct compression ratio', () {
        ...
        expect(metrics.compressionRatio, equals(testData.length / decimated.length));
      });
